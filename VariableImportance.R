...
definitions = c("The age of the participant in years.", "The weight of the participant in kilograms.", "The height of the participant in centimeters", "The biological sex of participant.", "The Body Mass Index of the participant. A measurement of weight in regards to height (Kg/m^2), to categorise an individual as underweight, healthy, overweight or obese.", "Whether there is a history of diabetes in the participant’s family. ", "Whether the participant has hypertension or not, which occurs when the individual’s blood pressure is too high.", 
...
getSummary <- function(var){
    return(describe(data$var))
}
