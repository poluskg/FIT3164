...
```
## User Interface R files
Each code chunk contains the contents of the R file in the title. Most of these files are used to make the user interface.

# userInputs_ui.R

These functions convert the user inputs in the front end to the format used by the classification model, so that predictions can be made using the users data.
```{r}
